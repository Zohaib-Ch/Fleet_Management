    ...
    <div className="space-y-12 view-transition pb-20">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
         ...
         <div className="flex flex-wrap gap-4">
            <button onClick={onBack} className="flex items-center gap-3 px-8 py-4 bg-white/5 border border-white/10 text-white font-black rounded-2xl hover:bg-white/10 transition-all uppercase tracking-widest text-[10px]">
            ...
            <button className="flex items-center gap-3 px-8 py-4 bg-red-600 text-white font-black rounded-2xl hover:bg-red-500 transition-all uppercase tracking-widest text-[10px] shadow-xl shadow-red-600/20">
        ...
        <div className="xl:col-span-2 space-y-10">
           ...
           >
              <div className="absolute top-10 left-10 z-10">
                 <h3 className="text-3xl font-luxury text-white tracking-tighter italic uppercase">Digital Twin v5.0</h3>
                 <p className="text-slate-500 font-bold uppercase tracking-[0.3em] text-[10px] mt-2">Real-time Structural Telemetry x 3D Projection</p>
              </div>
              ...
              >
                 ...
                 <div className="absolute bottom-0 w-full text-center">
                    <p className="text-[9px] font-black text-slate-500 uppercase tracking-[0.5em] animate-pulse">Swipe to Rotate Orbital Stream</p>
                 </div>
              </div>
              ...
              <div className="grid grid-cols-3 gap-12 w-full mt-10 relative z-20">
                 {[
                    ...
                    <div key={i} className="text-center space-y-2">
                       <span className="text-[10px] font-black text-slate-600 uppercase tracking-widest block">{stat.label}</span>
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              <HolographicCard glowColor="gold" className="p-10 rounded-[3rem]">
                  <div className="flex justify-between items-end mb-8">
                     <div>
                        <p className="text-[10px] text-slate-500 font-black uppercase tracking-[0.2em] mb-2">Energy Reserves</p>
                        <h4 className="text-4xl font-luxury text-white italic tracking-tighter">{car.fuelLevel}%</h4>
                     </div>
              ...
              <HolographicCard glowColor="blue" className="p-10 rounded-[3rem]">
                  <div className="flex justify-between items-end mb-8">
                     <div>
                        <p className="text-[10px] text-slate-500 font-black uppercase tracking-[0.2em] mb-2">Distance Traversed</p>
                        <h4 className="text-4xl font-luxury text-white italic tracking-tighter">{car.odometer} mi</h4>
                     </div>
           ...
           <HolographicCard glowColor="purple" className="p-10 rounded-[3.5rem]">
              ...
              <div className="space-y-8">
                 {[
                    ...
                    { label: 'Registered Driver', val: car.driver || 'N/A', color: 'text-white' },
                    { label: 'Registry Date', val: '01/15/2026', color: 'text-white' },
                 ...
                 {[
                    ...
                    <div key={i} className="relative pl-12">
                       ...
                       <div className="flex justify-between items-start mb-2">
                          <h4 className="text-sm font-black text-white uppercase italic tracking-tighter">{event.title}</h4>
                 ...
                 {[
                    ...
                    <div key={i} className="flex items-center gap-6 p-5 rounded-2xl bg-white/[0.02] border border-white/5">
                       ...
                       <div>
                          ...
                          <p className="text-sm font-black text-white uppercase italic tracking-tighter">{item.val}</p>
                       </div>
                    </div>
                 ))}
              </div>
          ...
          >
            ...
            >
              <div className="p-12 border-b border-white/5 flex justify-between items-center bg-white/[0.02]">
                <div>
                  <h3 className="text-3xl font-luxury text-white tracking-tighter italic uppercase">Service Terminal</h3>
                  <p className="text-slate-500 font-bold uppercase tracking-widest text-[10px] mt-2">Asset Maintenance Authorization Required</p>
                </div>
                <button onClick={() => setShowServiceForm(false)} className="w-14 h-14 flex items-center justify-center bg-white/5 rounded-2xl text-slate-500 hover:text-white transition-all border border-white/5">
                  <X size={28} />
                </button>
              </div>
              ...
              <div className="p-12">
                {serviceSuccess ? (
                  <div className="flex flex-col items-center justify-center py-16 text-center animate-in fade-in zoom-in duration-500">
                    ...
                    <h4 className="text-3xl font-luxury text-white uppercase italic tracking-tighter">Maintenance Logged</h4>
                    <p className="text-slate-500 font-bold uppercase tracking-widest text-[10px] mt-4">Structural integrity verified. Lifecycle registry updated.</p>
                  </div>
                ) : (
                  <form onSubmit={handleService} className="space-y-8">
                    <div className="space-y-8">
                       <div className="space-y-2">
                          <label className="text-[10px] font-black text-slate-600 uppercase tracking-[0.3em] ml-1">Service Classification</label>
                          <select className="w-full bg-white/[0.03] border border-white/10 rounded-2xl px-8 py-6 text-sm focus:bg-white/10 focus:border-gold outline-none transition-all font-black text-white appearance-none uppercase tracking-[0.2em]">
                       ...
                       <div className="space-y-2">
                          <label className="text-[10px] font-black text-slate-600 uppercase tracking-[0.3em] ml-1">Resource Allocation ($)</label>
                          <input required type="number" placeholder="Enter Cost Credits..." className="w-full bg-white/[0.03] border border-white/10 rounded-2xl px-8 py-6 text-sm focus:bg-white/10 focus:border-gold outline-none transition-all font-black text-white uppercase tracking-[0.2em]" />
                       </div>
                    </div>
                    <div className="pt-6">
