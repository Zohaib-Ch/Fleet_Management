...
export default function TripsView({ mapTheme, trips, setTrips, cars, setCars, drivers, addLog, onSelectCar, autoOpenForm, setAutoOpenForm }) {
   ...
   return (
      <div className="space-y-12 view-transition pb-24">
         ...
         <div className="glass-obsidian rounded-[3.5rem] p-12  relative overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col lg:flex-row justify-between items-start lg:items-center gap-10">
               <div>
                  ...
                  <p className="text-secondary font-bold uppercase tracking-[0.2em] text-xs max-w-xl leading-relaxed">
                     Manage trip lifecycles, tactical routing, and real-time fleet telemetry.
                  </p>
               </div>

               <div className="flex flex-wrap gap-4">
                  <div className="flex items-center p-2 bg-primary/5  rounded-2xl">
                  ...
                  <button onClick={() => setShowAddForm(true)} className="flex items-center gap-4 px-10 py-5 bg-gold text-obsidian font-black rounded-2xl hover:scale-[1.02] active:scale-95 transition-all shadow-2xl shadow-gold/10 uppercase tracking-[0.2em] text-[10px]">
                     <Plus size={20} strokeWidth={3} /> Add Trip
                  </button>
               </div>
            </div>
         </div>
                  ...
                  <HolographicCard glowColor={trip.status === 'Aborted' ? 'red' : trip.status === 'Delayed' ? 'gold' : 'blue'} className="p-10 rounded-[3.5rem] cursor-pointer">
                     ...
                     <div className="space-y-8 mb-10">
                        <div className="grid grid-cols-2 gap-4">
                           <div className="bg-primary/5  p-5 rounded-2xl space-y-2 group-hover: transition-colors">
                        ...
                        <div className="space-y-3 px-1">
                           ...
                           <div className="w-full h-2 bg-primary/5 rounded-full overflow-hidden p-0.5 ">
                              <motion.div
                                 initial={{ width: 0 }}
                     ...
                     <div className="flex justify-between items-center pt-8 border-t border-[var(--border-primary)] ">
                        <div className="flex items-center gap-4">
                           <img src={`https://i.pravatar.cc/150?u=${trip.driver}`} className="w-12 h-12 rounded-2xl border-2  shadow-xl" alt="operator" />
                           <div>
                        ...
                        <button className="w-12 h-12 bg-primary/5  rounded-2xl flex items-center justify-center text-secondary group-hover:text-gold group-hover:border-gold/20 transition-all">
                     ...
                     <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-10">
                        <div className="space-y-6">
                           <button onClick={() => setSelectedTrip(null)} className="group flex items-center gap-4 text-secondary hover:text-gold transition-all text-[10px] font-black uppercase tracking-[0.3em]">
                              <div className="w-10 h-10 rounded-xl bg-primary/5 flex items-center justify-center group-hover:bg-gold/10 group-hover:text-gold transition-all"><ArrowLeft size={18} /></div> Back to Trips
                           </button>
                           <div>
                        ...
                        <div className="flex flex-wrap gap-4">
                           <button onClick={() => onSelectCar(cars.find(c => c.id === selectedTrip.carId))} className="flex items-center gap-4 px-8 py-5 bg-blue-600 text-primary font-black rounded-2xl hover:bg-blue-500 transition-all uppercase tracking-widest text-[10px] shadow-2xl shadow-blue-600/30">
                     ...
                     <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
                        ...
                        <div className="lg:col-span-3 space-y-8">
                           <div className="h-[750px] rounded-[4rem] overflow-hidden  relative bg-obsidian-light shadow-2xl">
                              ...
                              {/* Playback HUD */}
                              <div className="absolute bottom-12 left-12 right-12 z-[1000] glass-obsidian p-10 rounded-[3rem]  flex items-center gap-12 shadow-3xl">
                                 <button
                                 ...
                                 <div className="flex-1 space-y-6">
                                    <div className="flex justify-between text-[10px] font-black text-secondary uppercase tracking-[0.4em]">
                                       <span className="flex items-center gap-2"><Compass size={14} /> Trip Start</span>
                                    ...
                                    <input
                                       ...
                                       className="w-full h-2 bg-primary/10 rounded-full appearance-none cursor-pointer accent-gold hover:accent-gold-light transition-all"
                                    />
                        ...
                        <div className="space-y-10">
                           <HolographicCard glowColor="blue" className="p-10 rounded-[3rem]">
                              <h3 className="text-xl font-luxury text-primary uppercase italic mb-8 flex items-center gap-4"><Activity className="text-blue-400" /> Trip Stats</h3>
                              <div className="space-y-6">
                                 {[
                                    ...
                                    <div key={i} className="flex justify-between items-center py-4 border-b  last:border-0">
                                       <div>
                                          ...
                                          <p className="text-sm font-black text-primary mt-1 uppercase">{s.val}</p>
                                       </div>
            ...
            {showAddForm && (
               ...
               >
                  <div className="flex-1 flex flex-col lg:flex-row h-full">
                     {/* Designer Sidebar */}
                     <div className="w-full lg:w-[500px] glass-obsidian border-r  flex flex-col shadow-3xl h-full">
                        <div className="p-12 border-b  space-y-6 shrink-0">
                           <div className="flex justify-between items-center">
                              <div>
                                 <h2 className="text-4xl font-luxury text-primary tracking-tighter uppercase italic">Trip <span className="text-gradient-gold">Designer</span></h2>
                                 <p className="text-[10px] text-gold font-black uppercase tracking-[0.4em] mt-1.5">Trip Deployment System</p>
                              </div>
                              <button onClick={() => { setShowAddForm(false); setPoints([]); }} className="w-14 h-14 bg-primary/5 hover:bg-primary/10 rounded-2xl flex items-center justify-center text-secondary hover:text-primary transition-all">
                                 <X size={24} />
                              </button>
                           </div>
                        </div>
                        ...
                        <div className="flex-1 overflow-y-auto p-12 space-y-12 custom-scrollbar pb-40">
                           {formSuccess ? (
                              <div className="py-20 text-center space-y-10 animate-in zoom-in duration-700">
                                 ...
                                 <div>
                                    <h3 className="text-3xl font-luxury text-primary uppercase italic tracking-tighter mb-4">Trip Authorized</h3>
                              ...
                              <form id="mission-form-final" onSubmit={handleAddTrip} className="space-y-12">
                                 ...
                                 <div className="glass-obsidian p-8 rounded-[2.5rem]  space-y-8">
                                    ...
                                    <div className="space-y-6">
                                       <div className="flex items-start gap-5">
                                          <div className={`w-10 h-10 rounded-2xl flex items-center justify-center border transition-all ${points[0] ? 'bg-blue-500/10 text-blue-400 border-blue-500/30' : 'bg-primary/5 text-secondary '}`}>
                                             <MapPin size={20} />
                                          </div>
                                          <div>
                                             <p className="text-[10px] font-black text-primary uppercase tracking-widest">Tactical Origin</p>
                                       ...
                                       <div className="flex items-start gap-5">
                                          <div className={`w-10 h-10 rounded-2xl flex items-center justify-center border transition-all ${points[1] ? 'bg-gold/10 text-gold border-gold/30' : 'bg-primary/5 text-secondary '}`}>
                                             <Target size={20} />
                                          </div>
                                          <div>
                                             <p className="text-[10px] font-black text-primary uppercase tracking-widest">Target Destination</p>
                     ...
                     <div className="flex-1 relative bg-obsidian-light h-full">
                        ...
                        <div className="absolute top-10 right-10 z-[1000] glass-obsidian px-8 py-6 rounded-3xl  shadow-3xl flex items-center gap-6">
                           <div className="w-12 h-12 bg-primary/5 rounded-2xl flex items-center justify-center text-gold shadow-inner">
                              <Compass size={24} className="animate-spin-slow" />
                           </div>
                           <div>
                              <p className="text-[10px] font-black text-primary uppercase tracking-[0.3em]">Map Engine v2.0</p>
                              <p className="text-[9px] text-secondary font-bold uppercase mt-1">Satellite Relay Synchronized</p>
                           </div>
                        </div>

                        <div className="absolute bottom-10 left-10 z-[1000] glass-obsidian px-10 py-6 rounded-[2.5rem]  shadow-3xl">
                           <div className="flex items-center gap-6">
                              <div className="flex items-center gap-3">
                                 <div className="w-3 h-3 rounded-full bg-blue-500 animate-pulse shadow-[0_0_10px_#3b82f6]"></div>
                                 <span className="text-[10px] font-black text-primary uppercase tracking-widest">Designate Origin</span>
                              </div>
                              ...
                              <div className="flex items-center gap-3">
                                 ...
                                 <span className="text-[10px] font-black text-primary uppercase tracking-widest">Set Target</span>
                              </div>
                           </div>
                        </div>
                     </div>
